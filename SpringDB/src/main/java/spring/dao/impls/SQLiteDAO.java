...
public class SQLiteDAO implements MP3Dao{
	...
	private SimpleJdbcTemplate updateMp3;
	...
	public void setDataSource(DataSource dataSource) {
	    ...
	    this.updateMp3 = new SimpleJdbcTemplate(dataSource);
	}
	...
	public int[] batchUpdate(List<MP3> mp3List) {
		SqlParameterSource[] params = SqlParameterSourceUtils.createBatch(mp3List.toArray());
		int updateCounts[] = updateMp3.batchUpdate("update mp3 set name = :name, author = :author where id = :id",
	            params);
		return null;
	}
}
